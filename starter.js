...
const calc = (num1, num2, callbackname) => {
...
const applyPrecentageDiscount = (product, discount) => {
...
applyDiscount(catProducts, .25, applyPrecentageDiscount)
...
const identifier = (arr) => arr.filter((job) => job.programmer)
